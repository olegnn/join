...
pub use union_impl::union;

#[proc_macro_hack(support_nested, internal_macro_calls = 20)]
pub use union_impl::union_async;

#[proc_macro_hack(support_nested, internal_macro_calls = 20)]
pub use union_impl::asyncion;

#[proc_macro_hack(support_nested)]
pub use union_impl::union_spawn;

#[proc_macro_hack(support_nested)]
pub use union_impl::spawnion;

#[proc_macro_hack(support_nested, internal_macro_calls = 20)]
pub use union_impl::union_async_spawn;

#[proc_macro_hack(support_nested, internal_macro_calls = 20)]
pub use union_impl::spasyncion;
